...
$result = $db->select(
  "SELECT * FROM `as_offerte` WHERE `status` > 1"
);
?>
      ...
      <div class="nk-block-head">
        <div class="nk-block">
          <div class="nk-block-head-content">
            <h2 class="nk-block-title fw-normal">Overzicht afgeronde offertes <a href="offerte" class="btn btn-md btn-primary"><span>Nieuwe leads bekijken</span></a></h2>
