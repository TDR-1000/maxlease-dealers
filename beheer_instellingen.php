                            ...
                            <div class="row">
                                <div class="col-lg-8 mb20">
                                    <div class="breadcrumb_content">
                                        <h2 class="breadcrumb_title">Instellingen</h2>
                                        <p>Overzicht van de website instellingen</p>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="p10-520">
                                <div class="row">
                                    <!-- Tab panes -->
                                    <div class="col-lg-12">
                                        <table id="dataForm" class="table table-striped" style="width:100%">
                                            <thead>
                                                <tr>
