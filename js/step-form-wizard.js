...
(function($){
    ...
    var defaults = {
        ...
        showButtons: true,
        showLegend: true,
        // AGB: oude versie      finishBtn: $('<input class="next-btn finish-btn sf-right sf-btn sf-btn-next"  style="width: 151px;margin-left: 0px;font-size: 15px;" type="submit" id="mybutton" value="' + button_fin_site +'"/>'),
        nextBtn: $('<a class="next-btn sf-right sf-btn" href="#">Volgende stap</a>'),
        prevBtn: $('<a class="prev-btn sf-left sf-btn" href="#">Vorige stap</a>'),
        finishBtn: $('<input class="finish-btn sf-right sf-btn" type="submit" value="Verstuur"/>'),
    ...
    stepFormWizard.prototype.wrapNavItem = function(step, index){
        ...
        /* AGB: gebruik bij mobiel de nav-top class en bij desktops/tablet nav-left */
        if($("html").hasClass("touch") && !$("html").hasClass("tablet")){
    ...
    stepFormWizard.prototype.setNavWidth = function(){
        ...
        if(w.config.showNav == 'left' || w.config.showNav == 'right'){
            ...
            // AGB: op smartphones de breedte met formuliervelden niet verminderen met de breedte
            // van de navigatiekolom
            if($("html").hasClass("touch") && !$("html").hasClass("tablet")){
              var contentWidth = w.element.closest('.sf-wizard').width();
            } else {
            ...
            // AGB: geen inline width="" waarde bij smartphones
            if(!$("html").hasClass("touch") || $("html").hasClass("tablet")){
